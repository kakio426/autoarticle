...
DATA_FILE = r"C:\Users\kakio\autoarticle\archive\data.csv"
IMAGE_DIR = r"C:\Users\kakio\autoarticle\archive\images"
...
samples = [
    {
        ...
        "images": json.dumps([os.path.join(IMAGE_DIR, "sample1.png")])
    },
    {
        "date": "2025/05/20",
        "school": "서울디지털초등학교",
        ...
        "images": json.dumps([os.path.join(IMAGE_DIR, "sample2.png")])
    },
    {
        "date": "2025/06/15",
        "school": "서울디지털초등학교",
...
df_new = pd.concat([df, pd.DataFrame(new_entries)], ignore_index=True)
df_new.to_csv(DATA_FILE, index=False, encoding='utf-8-sig')
print("Successfully added 6 sample articles.")
